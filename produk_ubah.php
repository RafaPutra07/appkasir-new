<?php
    ...
    if (isset($_POST['nama_produk'])) {
        ...
        if ($query) {
            echo '<script>alert("Ubah Barang Sukses"); location.href="?page=produk"</script>';
        } else {
            echo '<script>alert("Ubah Barang Gagal");</script>';
        }
    }
    ...
    <form method="post">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input class="form-control"  value="<?php echo $data['harga']; ?>" type="number" step="0" name="harga">
                </td>
            </tr>
            <tr>
                <td>Stok</td>
                <td>:</td>
                <td>
                    <input class="form-control"  value="<?php echo $data['stok']; ?>" type="number" step="0" name="stok">
                </td>
            </tr>
            <tr>
                <td></td>
