<?php
    ...
    if (isset($_POST['nama_pelanggan'])) {
        ...
        $query = mysqli_query($koneksi, "UPDATE pelanggan set nama_pelanggan = '$nama', alamat = '$alamat', nomer_telepon = '$no_telepon' WHERE id_pelanggan = '$id'");
        if ($query) {
            echo '<script>alert("Ubah Data Sukses"); location.href="?page=pelanggan"</script>';
        } else {
    ...
    <form method="post">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input class="form-control" type="number" step="0" value="<?php echo $data['nomer_telepon']; ?>" name="no_telepon">
                </td>
            </tr>
            <tr>
                <td></td>
