<?php
    ...
    if (isset($_POST['username'])) {
        ...
        if ($insert) {
            echo '<script>alert("Register Sukses"); location.href="login.php"</script>';
        } else {
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header bg-primary text-white text-center">
                                        <h3 class="font-weight-bold my-3">Register Aplikasi Kasir</h3>
                                    </div>
                                    <div class="card-body">
                                        <form method="post">
                                        <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" name="nama" placeholder="Masukkan Nama Lengkap" />
                                                <label for="inputEmail"><i class="fas fa-user"></i> Nama Lengkap</label>
                                            </div>
                                            <div class="form-floating mb-3">
